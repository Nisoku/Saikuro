...
pub fn register(suite: &mut TestSuite) {
    suite.register("core::call_envelope_roundtrip", call_envelope_roundtrip);
    suite.register("core::cast_envelope_roundtrip", cast_envelope_roundtrip);
    suite.register("core::stream_open_roundtrip", stream_open_roundtrip);
    suite.register("core::channel_open_roundtrip", channel_open_roundtrip);
    suite.register(
    ...
    suite.register("core::batch_envelope_roundtrip", batch_envelope_roundtrip);
    suite.register(
    ...
    suite.register("core::error_response_roundtrip", error_response_roundtrip);
    suite.register(
