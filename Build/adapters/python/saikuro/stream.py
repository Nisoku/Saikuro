...
from .error import ChannelClosedError, SaikuroError, StreamClosedError

SendFn = Callable[[str, Any], Coroutine[Any, Any, None]]


class _BaseStreamChannel:
    _closed_error_cls: type[SaikuroError] = SaikuroError

    def __init__(self, invocation_id: str) -> None:
        self._id = invocation_id
        self._queue: asyncio.Queue[ResponseEnvelope | None] = asyncio.Queue()
        self._closed = False
    ...
    async def __anext__(self) -> Any:
        ...
        if not item.ok:
            ...
            raise self._closed_error_cls("Closed", "ended with error", {})
...
class SaikuroStream(_BaseStreamChannel):
    """
    ...
    _closed_error_cls = StreamClosedError


class SaikuroChannel(_BaseStreamChannel):
    """
    ...
    _closed_error_cls = ChannelClosedError

    def __init__(self, invocation_id: str, send_fn: SendFn) -> None:
