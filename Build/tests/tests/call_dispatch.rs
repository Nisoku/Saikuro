...
#[tokio::test]
async fn call_returns_provider_response() {
...
#[tokio::test]
async fn cast_returns_ok_empty_immediately() {
...
#[tokio::test]
async fn call_to_unknown_namespace_returns_no_provider() {
...
#[tokio::test]
async fn call_to_dropped_provider_returns_unavailable() {
...
#[tokio::test]
async fn call_times_out_when_provider_does_not_respond() {
...
#[tokio::test]
async fn multiple_sequential_calls_all_succeed() {
...
#[tokio::test]
async fn call_with_null_target_returns_malformed_or_no_provider() {
    let registry = ProviderRegistry::new();
    let router = InvocationRouter::with_providers(registry);
...
#[tokio::test]
async fn cast_to_unknown_namespace_returns_ok() {
