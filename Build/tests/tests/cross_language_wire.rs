...
#[tokio::test]
async fn a_rust_provider_simulated_client_call() {
...
#[tokio::test]
async fn l_csharp_style_client_wire_fidelity() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
    ...
    let resp: ResponseEnvelope = rmp_serde::from_slice(&resp_frame).expect("csharp-style decode");
...
#[tokio::test]
async fn m_rust_adapter_client_calls_runtime_provider() {
    ...
    let (mut bridge_sender, mut bridge_receiver) = {
        let (ts, tr) = saikuro_transport::memory::MemoryTransport::pair("m-bridge", "m-bridge-rt");
        handle.accept_transport(
            tr,
...
/// the runtime.
#[tokio::test]
async fn n_rust_adapter_provider_serves_simulated_client() {
    use saikuro::transport::InMemoryTransport;
    ...
    let (mut bridge_sender, mut bridge_receiver) = {
        let (ts, tr) = saikuro_transport::memory::MemoryTransport::pair("n-bridge", "n-bridge-rt");
        handle.accept_transport(
            tr,
...
#[tokio::test]
async fn b_simulated_provider_rust_client_dispatch() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
#[tokio::test]
async fn c_rust_and_simulated_providers_coexist() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
    ...
    let ext_loop = tokio::spawn(async move {
...
#[tokio::test]
async fn d_batch_call_from_simulated_client() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
#[tokio::test]
async fn e_call_unknown_namespace_returns_error_on_wire() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
#[tokio::test]
async fn e_malformed_frame_returns_error_on_wire() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
#[tokio::test]
async fn f_announce_then_client_call_round_trip() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
    ...
    let prov_loop = tokio::spawn(async move {
...
#[tokio::test]
async fn g_concurrent_simulated_clients() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
#[tokio::test]
async fn h_cast_fire_and_forget_returns_ok_empty() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
#[tokio::test]
async fn i_provider_reconnect_and_reannounce() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
    ...
    let prov2_loop = tokio::spawn(async move {
...
#[tokio::test]
async fn j_typescript_style_client_wire_fidelity() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
...
/// promises/futures.
#[tokio::test]
async fn k_response_id_always_matches_request_id() {
    let runtime = SaikuroRuntime::builder().build();
    let handle = runtime.handle();
