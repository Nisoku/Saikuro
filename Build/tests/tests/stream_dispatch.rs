...
#[tokio::test]
async fn stream_open_returns_ok_empty() {
...
#[tokio::test]
async fn route_stream_item_delivers_to_state() {
    let (registry, mut work_rx) = make_provider("data");
...
#[tokio::test]
async fn route_stream_end_removes_state() {
    let (registry, mut work_rx) = make_provider("fin");
...
#[tokio::test]
async fn route_to_unknown_stream_returns_error() {
    let registry = ProviderRegistry::new();
    let router = InvocationRouter::with_providers(registry);
...
#[tokio::test]
async fn stream_open_to_unknown_namespace_returns_no_provider() {
    let registry = ProviderRegistry::new();
    let router = InvocationRouter::with_providers(registry);
...
#[tokio::test]
async fn out_of_order_item_is_dropped_not_panicked() {
...
#[tokio::test]
async fn stream_abort_control_removes_state() {
